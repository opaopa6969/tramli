...
exports.BranchBuilder = exports.SubFlowBuilder = exports.FromBuilder = exports.Builder = exports.FlowDefinition = void 0;
const flow_error_js_1 = require("./flow-error");
const data_flow_graph_js_1 = require("./data-flow-graph");
...
class Builder {
    ...
    finalize(def) {
        def.dataFlowGraph = data_flow_graph_js_1.DataFlowGraph.build(def, this.initiallyAvailableKeys, this.externallyProvidedKeys);
        const warnings = [];
    ...
    validate(def) {
        const errors = this.collectErrors(def);
        if (errors.length > 0) {
            throw new flow_error_js_1.FlowError('INVALID_FLOW_DEFINITION', `Flow '${this.name}' has ${errors.length} validation error(s):\n  - ${errors.map(e => e.message).join('\n  - ')}`);
        }
    }
...
exports.SubFlowBuilder = SubFlowBuilder;
class BranchBuilder {
    builder;
    fromState;
    branch;
